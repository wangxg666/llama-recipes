...
from dpo.my_dpo_trainer import DPOTrainer
...
class ScriptArguments:
    ...
    use_ref_model: Optional[bool] = field(default=False, metadata={'help': 'use reference model'})
    ...
    lora_enable: Optional[bool] = field(default=False, metadata={"help": "enable lora training"})
