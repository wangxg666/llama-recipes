    ...
    for day in time_range(sday, eday):
        ...
        for row in df.itertuples():
            ...
            datas.append({
                ...
                'description':  'I have fix some errors from the text, and the new text is: ' + str(row.full_text)
            })
            neg += 1
        ...
        for doc, feature in items[0:50]:
            ...
            if len(title_words) > 5:
                datas.append({
                    ...
                    'description': 'The text has no errors in it, ' + ' '.join(title_words),
                })
                pos += 1
...
if __name__ == '__main__':
    generate('2023-07-01', '2023-07-31', './datas/train.txt')
    generate('2023-08-01', '2023-08-08', './datas/valid.txt')